...
import Clientdb from "../Clientdb"; // Import the Dashboard component
...
const LoginClient = () => {
  ...
  const handleLogin = (event) => {
    ...
    setIsLoggedIn(true); // Set isLoggedIn state to true when login button is clicked
  };

  return (
    <div className="container" style={myComponentStyle}>
      {isLoggedIn ? ( // Conditionally render Dashboard component if user is logged in
        <Clientdb />
      ) : (
        <div className="text1">
          <input
